...
import org.fossify.shiguang.adapters.MyPagerAdapter
import org.fossify.shiguang.asynctasks.GetMediaAsynctask
import org.fossify.shiguang.databinding.ActivityMediumBinding
import org.fossify.shiguang.dialogs.DeleteWithRememberDialog
import org.fossify.shiguang.dialogs.SaveAsDialog
import org.fossify.shiguang.dialogs.SlideshowDialog
import org.fossify.shiguang.extensions.config
import org.fossify.shiguang.extensions.favoritesDB
import org.fossify.shiguang.extensions.fixDateTaken
import org.fossify.shiguang.extensions.getFavoritePaths
import org.fossify.shiguang.extensions.getShortcutImage
import org.fossify.shiguang.extensions.handleMediaManagementPrompt
import org.fossify.shiguang.extensions.hideSystemUI
import org.fossify.shiguang.extensions.isDownloadsFolder
import org.fossify.shiguang.extensions.launchResizeImageDialog
...
import org.fossify.shiguang.extensions.openEditor
import org.fossify.shiguang.extensions.openPath
import org.fossify.shiguang.extensions.restoreRecycleBinPath
import org.fossify.shiguang.extensions.saveRotatedImageToFile
import org.fossify.shiguang.extensions.setAs
import org.fossify.shiguang.extensions.shareMediumPath
import org.fossify.shiguang.extensions.showFileOnMap
import org.fossify.shiguang.extensions.showSystemUI
import org.fossify.shiguang.extensions.toggleFileVisibility
import org.fossify.shiguang.extensions.tryCopyMoveFilesTo
import org.fossify.shiguang.extensions.tryDeleteFileDirItem
import org.fossify.shiguang.extensions.updateDBMediaPath
import org.fossify.shiguang.extensions.updateFavorite
import org.fossify.shiguang.extensions.updateFavoritePaths
import org.fossify.shiguang.fragments.PhotoFragment
import org.fossify.shiguang.fragments.VideoFragment
import org.fossify.shiguang.fragments.ViewPagerFragment
import org.fossify.shiguang.helpers.BOTTOM_ACTION_CHANGE_ORIENTATION
import org.fossify.shiguang.helpers.BOTTOM_ACTION_COPY
import org.fossify.shiguang.helpers.BOTTOM_ACTION_DELETE
import org.fossify.shiguang.helpers.BOTTOM_ACTION_EDIT
import org.fossify.shiguang.helpers.BOTTOM_ACTION_MOVE
import org.fossify.shiguang.helpers.BOTTOM_ACTION_PROPERTIES
import org.fossify.shiguang.helpers.BOTTOM_ACTION_RENAME
import org.fossify.shiguang.helpers.BOTTOM_ACTION_RESIZE
import org.fossify.shiguang.helpers.BOTTOM_ACTION_ROTATE
import org.fossify.shiguang.helpers.BOTTOM_ACTION_SET_AS
import org.fossify.shiguang.helpers.BOTTOM_ACTION_SHARE
import org.fossify.shiguang.helpers.BOTTOM_ACTION_SHOW_ON_MAP
import org.fossify.shiguang.helpers.BOTTOM_ACTION_SLIDESHOW
import org.fossify.shiguang.helpers.BOTTOM_ACTION_TOGGLE_FAVORITE
import org.fossify.shiguang.helpers.BOTTOM_ACTION_TOGGLE_VISIBILITY
import org.fossify.shiguang.helpers.ColorModeHelper
import org.fossify.shiguang.helpers.DefaultPageTransformer
import org.fossify.shiguang.helpers.FadePageTransformer
import org.fossify.shiguang.helpers.GO_TO_NEXT_ITEM
import org.fossify.shiguang.helpers.GO_TO_PREV_ITEM
import org.fossify.shiguang.helpers.HIDE_SYSTEM_UI_DELAY
import org.fossify.shiguang.helpers.IS_VIEW_INTENT
import org.fossify.shiguang.helpers.MAX_PRINT_SIDE_SIZE
import org.fossify.shiguang.helpers.PATH
import org.fossify.shiguang.helpers.PORTRAIT_PATH
import org.fossify.shiguang.helpers.RECYCLE_BIN
import org.fossify.shiguang.helpers.ROTATE_BY_ASPECT_RATIO
import org.fossify.shiguang.helpers.ROTATE_BY_DEVICE_ROTATION
import org.fossify.shiguang.helpers.ROTATE_BY_SYSTEM_SETTING
import org.fossify.shiguang.helpers.SHOW_ALL
import org.fossify.shiguang.helpers.SHOW_FAVORITES
import org.fossify.shiguang.helpers.SHOW_NEXT_ITEM
import org.fossify.shiguang.helpers.SHOW_PREV_ITEM
import org.fossify.shiguang.helpers.SHOW_RECYCLE_BIN
import org.fossify.shiguang.helpers.SKIP_AUTHENTICATION
import org.fossify.shiguang.helpers.SLIDESHOW_ANIMATION_FADE
import org.fossify.shiguang.helpers.SLIDESHOW_ANIMATION_NONE
import org.fossify.shiguang.helpers.SLIDESHOW_ANIMATION_SLIDE
import org.fossify.shiguang.helpers.SLIDESHOW_DEFAULT_INTERVAL
import org.fossify.shiguang.helpers.SLIDESHOW_FADE_DURATION
import org.fossify.shiguang.helpers.SLIDESHOW_SLIDE_DURATION
...
import org.fossify.shiguang.helpers.TYPE_PORTRAITS
