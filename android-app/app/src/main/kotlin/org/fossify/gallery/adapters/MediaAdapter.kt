package org.fossify.shiguang.adapters
...
import org.fossify.shiguang.activities.ViewPagerActivity
import org.fossify.shiguang.databinding.PhotoItemGridBinding
import org.fossify.shiguang.databinding.PhotoItemListBinding
import org.fossify.shiguang.databinding.ThumbnailSectionBinding
import org.fossify.shiguang.databinding.VideoItemGridBinding
import org.fossify.shiguang.databinding.VideoItemListBinding
...
import org.fossify.shiguang.extensions.launchResizeMultipleImagesDialog
import org.fossify.shiguang.extensions.loadImage
import org.fossify.shiguang.extensions.openEditor
import org.fossify.shiguang.extensions.openPath
import org.fossify.shiguang.extensions.rescanFolderMedia
...
import org.fossify.shiguang.extensions.shareMediaPaths
...
import org.fossify.shiguang.helpers.ROUNDED_CORNERS_BIG
import org.fossify.shiguang.helpers.ROUNDED_CORNERS_NONE
import org.fossify.shiguang.helpers.ROUNDED_CORNERS_SMALL
...
class MediaAdapter(
    ...
    override fun prepareActionMode(menu: Menu) {
        ...
        if (menu.findItem(R.id.memory_create_story) == null) menu.add(0, R.id.memory_create_story, 0, "制作故事").setShowAsAction(android.view.MenuItem.SHOW_AS_ACTION_IF_ROOM)
        menu.findItem(R.id.memory_create_story).isVisible = !isInRecycleBin && !isAGetIntent
        menu.apply {
    ...
    override fun actionItemPressed(id: Int) {
        ...
        when (id) {
            R.id.memory_create_story -> {
                activity.startActivity(android.content.Intent(activity, org.fossify.shiguang.stories.StoryEditorActivity::class.java).putStringArrayListExtra("media_paths", getSelectedPaths()))
                finishActMode()
            }
