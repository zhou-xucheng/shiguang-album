...
import org.fossify.shiguang.dialogs.StoragePermissionRequiredDialog
...
open class SimpleActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: android.os.Bundle?) {
        ...
        theme.applyStyle(when {
            androidx.core.graphics.ColorUtils.calculateLuminance(getProperBackgroundColor()) <= .5 -> R.style.MemoryDarkOverlay
            getProperPrimaryColor() == 0xFF39654D.toInt() -> R.style.MemoryGreenOverlay
            getProperPrimaryColor() == 0xFF466687.toInt() -> R.style.MemoryBlueOverlay
            else -> R.style.MemoryLightOverlay
        }, true)
    }
